...
export const projects = [
  ...
  {
    slug: "carlos-philip-watches",
    title: "Carlos Philip Watches",
    category: "Consumer Product / Form & CMF Development",
    discipline: "Product",
    context: "Product design consultancy",
    year: "Consultancy",
    featured: false,
    problem:
      "A watch brand's product lines live or die on form coherence — each line needs a distinct yet manufacturable design language.",
    description:
      "Twelve watch form concepts developed across three foundational product lines, taken from exploration to production-ready digital assets.",
    impact:
      "12 watch form concepts; production-ready digital assets across 3 foundational product lines.",
    tools: ["Sketching", "CAD modelling", "Rendering", "CMF"],
    meta: ["Form development", "CMF", "Production-ready assets"],
    image: "https://images.pexels.com/photos/190819/pexels-photo-190819.jpeg?auto=compress&cs=tinysrgb&w=1600",
    imageAlt: "Luxury wristwatch with stainless steel bracelet — Carlos Philip form development",
    caseStudy: {
      outcome:
        "Twelve watch form concepts and production-ready digital assets developed across three foundational product lines for Carlos Philip Watches.",
      type: "Client consultancy · Consumer product design",
      role: "Product Design Consultant",
      timeline: "Consultancy engagement",
      team: "Individual consultancy with the Carlos Philip team",
      problemBody: [
        "Watch buyers read a brand through its form language — case profiles, dial layouts, and details that must stay coherent across an entire product line while each line keeps its own character.",
        "The challenge was to explore widely enough to find strong directions for three foundational product lines, then converge into digital assets precise enough for production — not just attractive visuals.",
      ],
      problemImage: "https://images.pexels.com/photos/31642726/pexels-photo-31642726.jpeg?auto=compress&cs=tinysrgb&w=1600",
      problemCaption:
        "A product line succeeds or fails on the coherence of its form language.",
      insights: [
        "Coherence across a product line matters more than any single design — buyers read the family, not just the watch.",
        "Exploration breadth de-risks convergence: comparing many distinct directions exposes which forms genuinely belong to the brand.",
        "At this scale, CMF decisions carry brand perception as much as geometry does.",
        "Digital assets only have value if they are production-ready — proportions, interfaces, and details must survive manufacturing.",
      ],
      direction: {
        body: "The direction was to treat each product line as its own form study: establish the character of the line, explore distinct interpretations of that character, and develop the strongest into production-ready assets.",
        decisions: [
          {
            title: "Line-first form languages",
            desc: "Each of the three foundational product lines was given its own formal character before concepts were developed within it.",
          },
          {
            title: "Wide exploration, disciplined convergence",
            desc: "Twelve distinct form concepts were developed and compared before converging on the directions worth refining.",
          },
          {
            title: "Production-ready as the bar",
            desc: "Concepts were only considered complete when their digital assets could support manufacturing, not just presentation.",
          },
        ],
      },
      ideation: {
        body: "Exploration moved from sketch-level form studies into CAD, comparing case profiles, dial architectures, and crown and strap interfaces across the three lines. Concepts that diluted a line's character were rejected even when individually attractive.",
        points: [
          "Sketch form studies across case profiles and proportions",
          "Dial architecture and detail exploration per product line",
          "Comparative review of all twelve concepts against line character",
          "Rejected directions documented against brand coherence, not taste",
        ],
        image: "https://images.pexels.com/photos/9713527/pexels-photo-9713527.jpeg?auto=compress&cs=tinysrgb&w=1600",
        imageAlt: "Close-up study of a steel wristwatch case and dial",
        caption: "Form and detail exploration across the product lines.",
      },
      mechanisms: {
        body: "Watch design at production level is component design: case, dial, hands, crown, glass, and strap interfaces must resolve together within tight dimensional constraints.",
        items: [
          {
            title: "Case and profile system",
            desc: "Case geometry and side profiles were developed as the primary carrier of each line's character.",
          },
          {
            title: "Dial architecture",
            desc: "Dial layouts, indices, and hand proportions were systematised per line for legibility and identity.",
          },
          {
            title: "Interface resolution",
            desc: "Crown, lug, and strap interfaces were detailed to production tolerance within the digital assets.",
          },
        ],
      },
      prototyping: {
        body: "Iteration happened in CAD and rendering, with successive digital prototypes refining proportion, surface transitions, and CMF until the assets were production-ready.",
        tests: [
          "Proportion and profile refinement across successive digital iterations",
          "CMF evaluation against each line's intended positioning",
          "Final asset review for production readiness",
        ],
      },
      solution: {
        body: "The engagement delivered twelve watch form concepts across Carlos Philip's three foundational product lines, with production-ready digital assets capturing case geometry, dial architecture, interfaces, and CMF.",
        features: [
          "12 distinct watch form concepts",
          "3 foundational product lines with coherent form languages",
          "Production-ready digital assets",
          "Resolved case, dial, and interface detailing",
        ],
        image: "https://images.pexels.com/photos/28157826/pexels-photo-28157826.jpeg?auto=compress&cs=tinysrgb&w=1600",
        imageAlt: "Elegant watch displayed on a stand — final presentation",
        caption: "Concepts developed to production-ready digital assets.",
      },
      outcomes: [
        "12 watch form concepts delivered",
        "Production-ready digital assets across 3 foundational product lines",
      ],
      reflection: {
        learned:
          "Consultancy work taught me to design at product-line scale: the discipline is not making one beautiful watch but building a form language that stays coherent across a family.",
        improve:
          "Physical prototypes and wrist-worn evaluation would be the natural next step, validating presence and comfort beyond digital review.",
        approach:
          "This project shows how I balance breadth and discipline: explore widely, compare honestly, and converge only when the assets can carry into production.",
      },
    },
  },
];
